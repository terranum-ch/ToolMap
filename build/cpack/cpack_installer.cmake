...
# Select installer generator for Windows
if (WIN32)
    ...
    set(CPACK_CREATE_UNINSTALL_REGISTRY_ENTRY OFF)
    # Removed desktop shortcut creation as per feedback
    # set(CPACK_CREATE_DESKTOP_LINKS "ToolMap")

    # Default to WIX unless USE_NSIS is set
    if (DEFINED USE_NSIS AND USE_NSIS)
        ...
        set(CPACK_WIX_PROPERTY_AUTOUPDATE "0")
