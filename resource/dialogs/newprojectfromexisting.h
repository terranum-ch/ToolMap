...
class ProjectNewExistDLG : public wxDialog {
 ...
 public:
  /// Constructors
  ProjectNewExistDLG();
  ProjectNewExistDLG(wxWindow* parent, wxWindowID id = SYMBOL_PROJECTNEWEXISTDLG_IDNAME,
                     const wxString& caption = SYMBOL_PROJECTNEWEXISTDLG_TITLE,
                     const wxPoint& pos = SYMBOL_PROJECTNEWEXISTDLG_POSITION,
                     const wxSize& size = SYMBOL_PROJECTNEWEXISTDLG_SIZE, long style = SYMBOL_PROJECTNEWEXISTDLG_STYLE);

  /// Creation
  bool Create(wxWindow* parent, wxWindowID id = SYMBOL_PROJECTNEWEXISTDLG_IDNAME,
              const wxString& caption = SYMBOL_PROJECTNEWEXISTDLG_TITLE,
              const wxPoint& pos = SYMBOL_PROJECTNEWEXISTDLG_POSITION,
              const wxSize& size = SYMBOL_PROJECTNEWEXISTDLG_SIZE, long style = SYMBOL_PROJECTNEWEXISTDLG_STYLE);
