...
Editvertexposition::Editvertexposition(wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos,
...
bool Editvertexposition::Create(wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos,
                                const wxSize& size, long style) {
...
void Editvertexposition::CreateControls() {
  ...
  wxStaticText* itemStaticText5 =
      new wxStaticText(itemDialog1, wxID_STATIC, _("Layer :"), wxDefaultPosition, wxDefaultSize, 0);
  itemFlexGridSizer4->Add(itemStaticText5, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);

  wxStaticText* itemStaticText6 =
      new wxStaticText(itemDialog1, wxID_STATIC, _("Line"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxStaticText* itemStaticText7 =
      new wxStaticText(itemDialog1, wxID_STATIC, _("Selected vertex :"), wxDefaultPosition, wxDefaultSize, 0);
  itemFlexGridSizer4->Add(itemStaticText7, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);

  wxStaticText* itemStaticText8 =
      new wxStaticText(itemDialog1, wxID_STATIC, _("2"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxToggleButton* itemToggleButton12 =
      new wxToggleButton(itemDialog1, ID_TOGGLEBUTTON26, _("+"), wxDefaultPosition, wxSize(40, -1), 0);
  ...
  wxToggleButton* itemToggleButton13 =
      new wxToggleButton(itemDialog1, ID_TOGGLEBUTTON27, _("-"), wxDefaultPosition, wxSize(40, -1), 0);
