...
Mergelines::Mergelines(wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos, const wxSize& size,
                       long style) {
  Init();
...
bool Mergelines::Create(wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos,
...
void Mergelines::CreateControls() {
  ...
  wxStaticText* itemStaticText3 =
      new wxStaticText(itemDialog1, wxID_STATIC, _("Choose the line with which other line will be merged"),
                       wxDefaultPosition, wxDefaultSize, 0);
  itemBoxSizer2->Add(itemStaticText3, 0, wxALIGN_CENTER_HORIZONTAL | wxALL, 5);

  wxArrayString itemListBox4Strings;
  wxListBox* itemListBox4 =
      new wxListBox(itemDialog1, ID_LISTBOX6, wxDefaultPosition, wxDefaultSize, itemListBox4Strings, wxLB_SINGLE);
