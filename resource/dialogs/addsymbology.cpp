...
AddSymbology::AddSymbology(wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos,
...
bool AddSymbology::Create(wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos,
                          const wxSize& size, long style) {
...
void AddSymbology::CreateControls() {
  ...
  wxStaticText* itemStaticText4 =
      new wxStaticText(itemDialog1, wxID_STATIC, _("Value :"), wxDefaultPosition, wxDefaultSize, 0);
  itemFlexGridSizer3->Add(itemStaticText4, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);

  wxArrayString itemComboBox5Strings;
  wxComboBox* itemComboBox5 = new wxComboBox(itemDialog1, ID_COMBOBOX1, _T(""), wxDefaultPosition, wxDefaultSize,
                                             itemComboBox5Strings, wxCB_DROPDOWN);
  itemFlexGridSizer3->Add(itemComboBox5, 0, wxGROW | wxALIGN_CENTER_VERTICAL | wxALL, 5);

  wxStaticText* itemStaticText6 =
      new wxStaticText(itemDialog1, wxID_STATIC, _("Color :"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxCheckBox* itemCheckBox8 =
      new wxCheckBox(itemDialog1, ID_CHECKBOX1, _("Transparent color"), wxDefaultPosition, wxDefaultSize, 0);
