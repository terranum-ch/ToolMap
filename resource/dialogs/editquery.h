...
public:
    /// Constructors
    EditQuery();
    EditQuery( wxWindow* parent, wxWindowID id = SYMBOL_EDITQUERY_IDNAME, const wxString& caption = SYMBOL_EDITQUERY_TITLE, const wxPoint& pos = SYMBOL_EDITQUERY_POSITION, const wxSize& size = SYMBOL_EDITQUERY_SIZE, long style = SYMBOL_EDITQUERY_STYLE );

    /// Creation
    bool Create( wxWindow* parent, wxWindowID id = SYMBOL_EDITQUERY_IDNAME, const wxString& caption = SYMBOL_EDITQUERY_TITLE, const wxPoint& pos = SYMBOL_EDITQUERY_POSITION, const wxSize& size = SYMBOL_EDITQUERY_SIZE, long style = SYMBOL_EDITQUERY_STYLE );
