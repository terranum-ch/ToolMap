...
////@begin ProjectDefFieldDlg content construction
    // Generated by DialogBlocks, Tue 8 Apr 16:49:51 2008 (Personal Edition)
    ...
    m_DlgAFD_Coded_Val_List = new ProjectDefFieldList( itemDialog1, ID_DLGAFD_CODED_VAL_LIST, wxDefaultPosition, wxSize(100, 200), wxLC_REPORT );
    ...
    wxFlatButton* itemFlatButton21 = new wxFlatButton( itemDialog1, ID_DLGAFD_VAL_ADD, _("+"), wxDefaultPosition, wxSize(40, -1), 0 );
    itemFlatButton21->SetValue(false);
    itemBoxSizer20->Add(itemFlatButton21, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT|wxTOP|wxBOTTOM, 5);

    wxFlatButton* itemFlatButton22 = new wxFlatButton( itemDialog1, ID_DLGAFD_VAL_REMOVE, _("-"), wxDefaultPosition, wxSize(40, -1), 0 );
    itemFlatButton22->SetValue(false);
    itemBoxSizer20->Add(itemFlatButton22, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT|wxTOP|wxBOTTOM, 5);

    wxFlatButton* itemFlatButton23 = new wxFlatButton( itemDialog1, ID_DLGAFD_VAL_IMPORT, _("Import..."), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlatButton23->SetValue(false);
    itemBoxSizer20->Add(itemFlatButton23, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT|wxTOP|wxBOTTOM, 5);

    wxFlatButton* itemFlatButton24 = new wxFlatButton( itemDialog1, ID_DLGAFD_VAL_EXPORT, _("Export..."), wxDefaultPosition, wxDefaultSize, 0 );
