...
ProjectEditObjectDefinitionDLG::ProjectEditObjectDefinitionDLG(wxWindow* parent, wxWindowID id, const wxString& caption,
...
void ProjectEditObjectDefinitionDLG::CreateControls() {
  ...
  m_DLGPEO_List_Line =
      new ListParam(m_DLGPEO_Panel_Line, ID_DLGPEO_LISTLINE, wxDefaultPosition, wxSize(400, 200), wxLC_REPORT);
  ...
  wxStaticText* itemStaticText8 =
      new wxStaticText(m_DLGPEO_Panel_Line, wxID_STATIC, _("Layer name :"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_DLGPEO_Choice_Lyr_Line_Name = new wxChoice(m_DLGPEO_Panel_Line, ID_DLGPEO_LYR_NAME_LINE, wxDefaultPosition,
                                               wxDefaultSize, m_DLGPEO_Choice_Lyr_Line_NameStrings, 0);
  m_DLGPEO_Choice_Lyr_Line_Name->SetStringSelection(_("Polygons_TS"));
  itemFlexGridSizer7->Add(m_DLGPEO_Choice_Lyr_Line_Name, 0,
                          wxGROW | wxALIGN_CENTER_VERTICAL | wxLEFT | wxRIGHT | wxBOTTOM, 5);

  m_DLGPEO_Choice_Lyr_Line_Freq =
      new wxCheckBox(m_DLGPEO_Panel_Line, ID_DLGPEO_LINE_FRQ, _("This object is frequently used"), wxDefaultPosition,
                     wxDefaultSize, 0);
  ...
  m_DLGPEO_List_Line =
      new ListParam(m_DLGPEO_Panel_Point, ID_DLGPEO_LISTPOINT, wxDefaultPosition, wxSize(400, 200), wxLC_REPORT);
  ...
  wxStaticText* itemStaticText15 =
      new wxStaticText(m_DLGPEO_Panel_Point, wxID_STATIC, _("Layer name :"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_DLGPEO_Choice_Lyr_Point_Name = new wxChoice(m_DLGPEO_Panel_Point, ID_DLGPEO_LYR_NAME_POINT, wxDefaultPosition,
                                                wxDefaultSize, m_DLGPEO_Choice_Lyr_Point_NameStrings, 0);
  m_DLGPEO_Choice_Lyr_Point_Name->SetStringSelection(_("Polygons_TS"));
  itemFlexGridSizer14->Add(m_DLGPEO_Choice_Lyr_Point_Name, 0,
                           wxGROW | wxALIGN_CENTER_VERTICAL | wxLEFT | wxRIGHT | wxBOTTOM, 5);
  ...
  m_DLGPEO_List_Line =
      new ListParam(m_DLGPEO_Panel_Poly, ID_DLGPEO_LISTPOLY, wxDefaultPosition, wxSize(400, 200), wxLC_REPORT);
  ...
  wxStaticText* itemStaticText21 =
      new wxStaticText(m_DLGPEO_Panel_Poly, wxID_STATIC, _("Layer name :"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_DLGPEO_Choice_Lyr_Poly_Name = new wxChoice(m_DLGPEO_Panel_Poly, ID_DLGPEO_LYR_NAME_POLY, wxDefaultPosition,
                                               wxDefaultSize, m_DLGPEO_Choice_Lyr_Poly_NameStrings, 0);
  m_DLGPEO_Choice_Lyr_Poly_Name->SetStringSelection(_("Polygons_TS"));
  itemFlexGridSizer20->Add(m_DLGPEO_Choice_Lyr_Poly_Name, 0,
                           wxGROW | wxALIGN_CENTER_VERTICAL | wxLEFT | wxRIGHT | wxBOTTOM, 5);
  ...
  wxToggleButton* itemToggleButton24 =
      new wxToggleButton(itemDialog1, ID_TOGGLEBUTTON8, _("+"), wxDefaultPosition, wxSize(40, -1), 0);
  ...
  wxToggleButton* itemToggleButton25 =
      new wxToggleButton(itemDialog1, ID_TOGGLEBUTTON9, _("-"), wxDefaultPosition, wxSize(40, -1), 0);
  ...
  wxToggleButton* itemToggleButton26 =
      new wxToggleButton(itemDialog1, ID_TOGGLEBUTTON10, _("Import..."), wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxToggleButton* itemToggleButton27 =
      new wxToggleButton(itemDialog1, ID_TOGGLEBUTTON11, _("Export..."), wxDefaultPosition, wxDefaultSize, 0);
  itemToggleButton27->SetValue(false);
  itemStaticBoxSizer23->Add(itemToggleButton27, 0, wxALIGN_CENTER_VERTICAL | wxALL, 5);

  wxStaticLine* itemStaticLine28 =
