...
#define SYMBOL_OBJECTDEFINITIONLISTDLG_STYLE \
  wxCAPTION | wxRESIZE_BORDER | wxSYSTEM_MENU | wxCLOSE_BOX | wxDIALOG_MODAL | wxTAB_TRAVERSAL
...
class ObjectDefinitionListDlg : public wxDialog {
 ...
 public:
  ...
  ObjectDefinitionListDlg(wxWindow* parent, wxWindowID id = SYMBOL_OBJECTDEFINITIONLISTDLG_IDNAME,
  ...
  /// Creation
  bool Create(wxWindow* parent, wxWindowID id = SYMBOL_OBJECTDEFINITIONLISTDLG_IDNAME,
              const wxString& caption = SYMBOL_OBJECTDEFINITIONLISTDLG_TITLE,
              const wxPoint& pos = SYMBOL_OBJECTDEFINITIONLISTDLG_POSITION,
              const wxSize& size = SYMBOL_OBJECTDEFINITIONLISTDLG_SIZE,
              long style = SYMBOL_OBJECTDEFINITIONLISTDLG_STYLE);
