...
Importdata::Importdata(wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos, const wxSize& size,
                       long style) {
  Init();
...
bool Importdata::Create(wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos,
...
void Importdata::CreateControls() {
  ...
  wxStaticText* itemStaticText7 =
      new wxStaticText(itemPanel4, wxID_STATIC, _("Shapefile :"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxStaticText* itemStaticText11 =
      new wxStaticText(itemPanel4, wxID_STATIC, _("Shapefile type :"), wxDefaultPosition, wxDefaultSize, 0);
  itemBoxSizer10->Add(itemStaticText11, 0, wxALIGN_CENTER_VERTICAL | wxRIGHT | wxBOTTOM, 5);

  wxStaticText* itemStaticText12 =
      new wxStaticText(itemPanel4, wxID_STATIC, _("Lines"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxCheckBox* itemCheckBox14 =
      new wxCheckBox(itemPanel4, ID_CHECKBOX3, _("Import attributes"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxListBox* itemListBox15 =
      new wxListBox(itemPanel4, ID_LISTBOX1, wxDefaultPosition, wxDefaultSize, itemListBox15Strings, wxLB_SINGLE);
  ...
  wxStaticText* itemStaticText17 =
      new wxStaticText(itemPanel4, wxID_STATIC, _("Project field :"), wxDefaultPosition, wxDefaultSize, 0);
  itemBoxSizer16->Add(itemStaticText17, 0, wxALIGN_CENTER_VERTICAL | wxALL, 5);

  wxArrayString itemChoice18Strings;
  wxChoice* itemChoice18 =
      new wxChoice(itemPanel4, ID_CHOICE18, wxDefaultPosition, wxDefaultSize, itemChoice18Strings, 0);
  ...
  wxStaticText* itemStaticText21 =
      new wxStaticText(itemPanel19, wxID_STATIC,
                       _("Warning : the imported project \nmust contain the exact same \nstructure as the actual one"),
  ...
  wxStaticText* itemStaticText23 =
      new wxStaticText(itemPanel19, wxID_STATIC, _("Path :"), wxDefaultPosition, wxDefaultSize, 0);
