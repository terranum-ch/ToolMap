...
class Snapping : public wxDialog {
 ...
 public:
  /// Constructors
  Snapping();
  Snapping(wxWindow* parent, wxWindowID id = SYMBOL_SNAPPING_IDNAME, const wxString& caption = SYMBOL_SNAPPING_TITLE,
           const wxPoint& pos = SYMBOL_SNAPPING_POSITION, const wxSize& size = SYMBOL_SNAPPING_SIZE,
           long style = SYMBOL_SNAPPING_STYLE);

  /// Creation
  bool Create(wxWindow* parent, wxWindowID id = SYMBOL_SNAPPING_IDNAME, const wxString& caption = SYMBOL_SNAPPING_TITLE,
              const wxPoint& pos = SYMBOL_SNAPPING_POSITION, const wxSize& size = SYMBOL_SNAPPING_SIZE,
              long style = SYMBOL_SNAPPING_STYLE);
