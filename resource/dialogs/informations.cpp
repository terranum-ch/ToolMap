...
Informations::Informations(wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos,
...
bool Informations::Create(wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos,
                          const wxSize& size, long style) {
...
void Informations::CreateControls() {
  ...
  wxChoice* itemChoice5 =
      new wxChoice(itemDialog1, ID_CHOICE9, wxDefaultPosition, wxDefaultSize, itemChoice5Strings, 0);
  itemFlexGridSizer3->Add(itemChoice5, 0, wxGROW | wxALIGN_CENTER_VERTICAL | wxALL, 5);

  wxStaticText* itemStaticText6 =
      new wxStaticText(itemDialog1, wxID_STATIC, _("Location :"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxStaticText* itemStaticText8 =
      new wxStaticText(itemDialog1, wxID_STATIC, _("x"), wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT);
  itemBoxSizer7->Add(itemStaticText8, 1, wxALIGN_CENTER_VERTICAL | wxLEFT | wxRIGHT, 5);

  wxStaticLine* itemStaticLine9 =
      new wxStaticLine(itemDialog1, ID_STATICLINE, wxDefaultPosition, wxDefaultSize, wxLI_VERTICAL);
