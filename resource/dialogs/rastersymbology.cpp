...
Rastersymbology::Rastersymbology(wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos,
...
bool Rastersymbology::Create(wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos,
                             const wxSize& size, long style) {
...
void Rastersymbology::CreateControls() {
  ...
  wxSlider* itemSlider5 =
      new wxSlider(itemDialog1, ID_SLIDER2, 0, 0, 100, wxDefaultPosition, wxDefaultSize, wxSL_HORIZONTAL);
  ...
  wxButton* itemButton9 =
      new wxButton(itemDialog1, ID_BUTTON34, _("Pick a color"), wxDefaultPosition, wxDefaultSize, 0);
