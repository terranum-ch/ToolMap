...
public:
	...
	static TEST_Backup *createSuite() { return new TEST_Backup(true);}
    static void destroySuite( TEST_Backup *suite ) { delete suite; }
    ...
    void testGetFileInfo(){
        ...
        BackupManager myManager(m_Database);
        TS_ASSERT(myManager.GetFileInfo(wxFileName(g_TestPathBackup, _T("testbackup-2000-01-01-120000.tmbk")),
                                        myInfoFile));
