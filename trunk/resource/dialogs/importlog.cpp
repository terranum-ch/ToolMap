...
////@begin ImportLog content construction
    // Generated by DialogBlocks, Tue 13 Nov 10:02:02 2007 (Personal Edition)
    ...
    wxTextCtrl* itemTextCtrl4 = new wxTextCtrl( itemDialog1, ID_TEXTCTRL18, _T(""), wxDefaultPosition, wxDefaultSize, wxTE_MULTILINE );
    itemStaticBoxSizer3->Add(itemTextCtrl4, 1, wxGROW|wxALL, 5);

    wxButton* itemButton5 = new wxButton( itemDialog1, ID_BUTTON24, _("OK"), wxDefaultPosition, wxDefaultSize, 0 );
