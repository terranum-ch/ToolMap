...
////@begin ProjectDefFieldDlg content construction
    ...
    m_DlgAFD_Constrain_Panel = new wxPanel( itemDialog1, ID_DLGAFD_CONSTRAIN_PANL, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
    ...
    m_DlgAFD_Coded_Val_List = new ProjectDefFieldList( m_DlgAFD_Constrain_Panel, ID_DLGAFD_CODED_VAL_LIST, wxDefaultPosition, wxSize(100, 200), wxLC_REPORT );
    ...
    wxFlatButton* itemFlatButton22 = new wxFlatButton( m_DlgAFD_Constrain_Panel, ID_DLGAFD_VAL_ADD, _("+"), wxDefaultPosition, wxSize(40, -1), 0 );
    itemFlatButton22->SetValue(false);
    itemBoxSizer21->Add(itemFlatButton22, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT|wxTOP|wxBOTTOM, 5);

    wxFlatButton* itemFlatButton23 = new wxFlatButton( m_DlgAFD_Constrain_Panel, ID_DLGAFD_VAL_REMOVE, _("-"), wxDefaultPosition, wxSize(40, -1), 0 );
    itemFlatButton23->SetValue(false);
    itemBoxSizer21->Add(itemFlatButton23, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT|wxTOP|wxBOTTOM, 5);

    wxFlatButton* itemFlatButton24 = new wxFlatButton( m_DlgAFD_Constrain_Panel, ID_DLGAFD_VAL_IMPORT, _("Import..."), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlatButton24->SetValue(false);
    itemBoxSizer21->Add(itemFlatButton24, 0, wxALIGN_CENTER_VERTICAL|wxRIGHT|wxTOP|wxBOTTOM, 5);

    wxFlatButton* itemFlatButton25 = new wxFlatButton( m_DlgAFD_Constrain_Panel, ID_DLGAFD_VAL_EXPORT, _("Export..."), wxDefaultPosition, wxDefaultSize, 0 );
