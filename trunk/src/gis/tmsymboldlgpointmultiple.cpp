...
tmSymbolDLGPointMultiple::tmSymbolDLGPointMultiple( wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos, const wxSize& size, long style )
{
    _Init();
...
bool tmSymbolDLGPointMultiple::Create( wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos, const wxSize& size, long style )
{
