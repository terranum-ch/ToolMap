...
class WXDLLEXPORT wxTreeMultiEvent : public wxNotifyEvent {
 public:
  ...
  virtual wxEvent *Clone() const {
    return new wxTreeMultiEvent(*this);
  }
...
#define wxTreeMultiEventHandler(func) \
  (wxObjectEventFunction)(wxEventFunction) wxStaticCastEvent(wxTreeMultiEventFunction, &func)

// standard events similar or identical to wxTreeEvent:
#define EVT_TREE_MULTI_BEGIN_DRAG \
  (id, fn) wx__DECLARE_EVT1(wxEVT_COMMAND_TREE_BEGIN_DRAG, id, wxTreeMultiEventHandler(fn))
#define EVT_TREE_MULTI_BEGIN_RDRAG(id, fn) \
  wx__DECLARE_EVT1(wxEVT_COMMAND_TREE_BEGIN_RDRAG, id, wxTreeMultiEventHandler(fn))
#define EVT_TREE_MULTI_END_DRAG (id, fn) wx__DECLARE_EVT1(wxEVT_COMMAND_TREE_END_DRAG, id, wxTreeMultiEventHandler(fn))
#define EVT_TREE_MULTI_BEGIN_LABEL_EDIT(id, fn) \
  wx__DECLARE_EVT1(wxEVT_COMMAND_TREE_BEGIN_LABEL_EDIT, id, wxTreeMultiEventHandler(fn))
#define EVT_TREE_MULTI_END_LABEL_EDIT(id, fn) \
  wx__DECLARE_EVT1(wxEVT_COMMAND_TREE_END_LABEL_EDIT, id, wxTreeMultiEventHandler(fn))
...
#define EVT_TREE_MULTI_ITEM_EXPANDED(id, fn) \
  wx__DECLARE_EVT1(wxEVT_COMMAND_TREE_MULTI_ITEM_EXPANDED, id, wxTreeMultiEventHandler(fn))
#define EVT_TREE_MULTI_ITEM_EXPANDING(id, fn) \
  wx__DECLARE_EVT1(wxEVT_COMMAND_TREE_MULTI_ITEM_EXPANDING, id, wxTreeMultiEventHandler(fn))
#define EVT_TREE_MULTI_ITEM_COLLAPSED(id, fn) \
  wx__DECLARE_EVT1(wxEVT_COMMAND_TREE_MULTI_ITEM_COLLAPSED, id, wxTreeMultiEventHandler(fn))
#define EVT_TREE_MULTI_ITEM_COLLAPSING(id, fn) \
  wx__DECLARE_EVT1(wxEVT_COMMAND_TREE_MULTI_ITEM_COLLAPSING, id, wxTreeMultiEventHandler(fn))
#define EVT_TREE_MULTI_SEL_CHANGED(id, fn) \
  wx__DECLARE_EVT1(wxEVT_COMMAND_TREE_SEL_CHANGED, id, wxTreeMultiEventHandler(fn))
#define EVT_TREE_MULTI_SEL_CHANGING(id, fn) \
  wx__DECLARE_EVT1(wxEVT_COMMAND_TREE_SEL_CHANGING, id, wxTreeMultiEventHandler(fn))
#define EVT_TREE_MULTI_KEY_DOWN(id, fn) wx__DECLARE_EVT1(wxEVT_COMMAND_TREE_KEY_DOWN, id, wxTreeMultiEventHandler(fn))
#define EVT_TREE_MULTI_DELETE_ITEM(id, fn) \
  wx__DECLARE_EVT1(wxEVT_COMMAND_TREE_DELETE_ITEM, id, wxTreeMultiEventHandler(fn))
#define EVT_TREE_MULTI_ITEM_ACTIVATED(id, fn) \
  wx__DECLARE_EVT1(wxEVT_COMMAND_TREE_MULTI_ITEM_ACTIVATED, id, wxTreeMultiEventHandler(fn))
#define EVT_TREE_MULTI_ITEM_MENU(id, fn) \
  wx__DECLARE_EVT1(wxEVT_COMMAND_TREE_MULTI_ITEM_MENU, id, wxTreeMultiEventHandler(fn))
#define EVT_TREE_MULTI_ITEM_RIGHT_CLICK(id, fn) \
  wx__DECLARE_EVT1(wxEVT_COMMAND_TREE_MULTI_ITEM_RIGHT_CLICK, id, wxTreeMultiEventHandler(fn))
#define EVT_TREE_MULTI_ITEM_MIDDLE_CLICK(id, fn) \
  wx__DECLARE_EVT1(wxEVT_COMMAND_TREE_MULTI_ITEM_MIDDLE_CLICK, id, wxTreeMultiEventHandler(fn))
#define EVT_TREE_MULTI_STATE_IMAGE_CLICK(id, fn) \
  wx__DECLARE_EVT1(wxEVT_COMMAND_TREE_STATE_IMAGE_CLICK, id, wxTreeMultiEventHandler(fn))
#define EVT_TREE_MULTI_ITEM_GETTOOLTIP(id, fn) \
  wx__DECLARE_EVT1(wxEVT_COMMAND_TREE_MULTI_ITEM_GETTOOLTIP, id, wxTreeMultiEventHandler(fn))
