...
tmLabelDLG::tmLabelDLG(wxWindow *parent, tmLayerProperties *properties, const wxPoint &pos, wxWindowID id,
                       const wxString &title, const wxSize &size, long style)
...
void tmLabelDLG::_CreateControls() {
  ...
  m_CheckActiveLabelCtrl =
      new wxCheckBox(this, wxID_ANY, _("Enable labels for this layer"), wxDefaultPosition, wxDefaultSize, 0);
