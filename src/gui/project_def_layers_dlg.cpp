...
ProjectDefLayersEditObjectDlg::ProjectDefLayersEditObjectDlg(wxWindow* parent, wxWindowID id, const wxString& caption,
                                                             const wxPoint& pos, const wxSize& size, long style) {
    Init();
    Create(parent, id, caption, pos, size, style);
}

bool ProjectDefLayersEditObjectDlg::Create(wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos,
...
void ProjectDefLayersEditObjectDlg::CreateDlgControls() {
    ...
    wxStaticText* itemStaticText4 = new wxStaticText(itemDialog1, wxID_STATIC, _("Code :"), wxDefaultPosition,
                                                     wxDefaultSize, 0);
    itemFlexGridSizer3->Add(itemStaticText4, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);

    wxStaticText* itemStaticText5 = new wxStaticText(itemDialog1, wxID_STATIC, _("Description :"), wxDefaultPosition,
                                                     wxDefaultSize, 0);
    ...
    wxStaticLine* itemStaticLine8 = new wxStaticLine(itemDialog1, ID_STATICLINE2, wxDefaultPosition, wxDefaultSize,
                                                     wxLI_HORIZONTAL);
...
void ProjectDefLayersDlg::OnImportObject(wxCommandEvent& event) {
    ...
    if (myImportSelector.ShowModal() == wxID_OK) {
        m_DlgPDL_Object_List->ImportParsedFileToListCtrl(myImportSelector.GetPath(), myImportSelector.GetFilterIndex());
    }
}
...
void ProjectDefLayersDlg::OnSelectLayerType(wxCommandEvent& event) {
    ...
    if (iActualSpatType >= LAYER_LINE && iActualSpatType <= LAYER_POLYGON)
        if (m_DlgPDL_Object_List) m_DlgPDL_Object_List->SetSpatialType(iActualSpatType);

    bool bShowPolyCtrl = false;
    if (iActualSpatType == LAYER_POLYGON) bShowPolyCtrl = true;
...
void ProjectDefLayersDlg::ActivateOrientation() {
    ...
    if (m_DlgPDL_Layer_Type->GetSelection() == LAYER_POINT) bActivated = TRUE;
...
ProjectDefLayersDlg::ProjectDefLayersDlg(wxWindow* parent, PrjDefMemManage* pPrjDef, bool isEditingMode,
                                         bool isAddingMode, wxWindowID id, const wxString& caption, const wxPoint& pos,
                                         const wxSize& size, long style) {
    Init();
...
ProjectDefLayersDlg::~ProjectDefLayersDlg() {
    ...
    if (!m_FieldArray.IsEmpty()) m_FieldArray.Clear();
}
...
void ProjectDefLayersDlg::CreateControls() {
    ...
    wxStaticText* itemStaticText7 = new wxStaticText(itemDialog1, wxID_STATIC, _("Layer name :"), wxDefaultPosition,
                                                     wxDefaultSize, 0);
    itemFlexGridSizer4->Add(itemStaticText7, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);

    m_DlgPDL_Layer_Name = new wxTextCtrl(itemDialog1, ID_DLGPDL_LAYER_NAME, _T(""), wxDefaultPosition, wxSize(200, -1),
                                         0);
    itemFlexGridSizer4->Add(m_DlgPDL_Layer_Name, 0, wxGROW | wxALIGN_CENTER_VERTICAL | wxALL, 5);

    wxStaticText* itemStaticText5 = new wxStaticText(itemDialog1, wxID_STATIC, _("Layer type :"), wxDefaultPosition,
                                                     wxDefaultSize, 0);
    itemFlexGridSizer4->Add(itemStaticText5, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);

    m_DlgPDL_Layer_Type = new wxChoice(itemDialog1, ID_DLGPDL_LAYER_TYPE, wxDefaultPosition, wxDefaultSize,
                                       PRJDEF_LAYERS_TYPE_NUMBER, PRJDEF_LAYERS_TYPE_STRING, 0);
    ...
    wxNotebook* itemNotebook9 = new wxNotebook(itemDialog1, ID_NOTEBOOK, wxDefaultPosition, wxDefaultSize,
                                               wxBK_DEFAULT);

    if (!m_bIsModeEditing) {
        m_DlgPDL_Panel_Obj = new wxPanel(itemNotebook9, ID_DLGPDL_PANEL_OBJ, wxDefaultPosition, wxDefaultSize,
                                         wxTAB_TRAVERSAL);
        ...
        wxFlatButton* itemFlatButton14 = new wxFlatButton(m_DlgPDL_Panel_Obj, ID_DLGPDL_OBJECT_ADD,
                                                          wxFLATBUTTON_TEXT_ADD);
        itemBoxSizer13->Add(itemFlatButton14, 0, wxALIGN_CENTER_VERTICAL | wxRIGHT | wxTOP | wxBOTTOM, 5);

        wxFlatButton* itemFlatButton15 = new wxFlatButton(m_DlgPDL_Panel_Obj, ID_DLGPDL_OBJECT_REMOVE,
                                                          wxFLATBUTTON_TEXT_REMOVE);
        itemBoxSizer13->Add(itemFlatButton15, 0, wxALIGN_CENTER_VERTICAL | wxRIGHT | wxTOP | wxBOTTOM, 5);

        wxFlatButton* itemFlatButton16 = new wxFlatButton(m_DlgPDL_Panel_Obj, ID_DLGPDL_OBJECT_IMPORT, _("Import"),
                                                          wxDefaultSize);
    ...
    m_DlgPDL_Panel_Fields = new wxPanel(itemNotebook9, ID_DLGPDL_PANEL_FIELDS, wxDefaultPosition, wxDefaultSize,
                                        wxTAB_TRAVERSAL);
    ...
    m_DlgPDL_Fields_List = new ProjectDefLayersFieldsList(m_DlgPDL_Panel_Fields, ID_DLGPDL_FIELDS_LIST,
                                                          wxSize(100, 100), this);
    ...
    wxFlatButton* itemFlatButton21 = new wxFlatButton(m_DlgPDL_Panel_Fields, ID_DLGPDL_FIELD_ADD,
                                                      wxFLATBUTTON_TEXT_ADD);
    itemBoxSizer20->Add(itemFlatButton21, 0, wxALIGN_CENTER_VERTICAL | wxRIGHT | wxTOP | wxBOTTOM, 5);

    wxFlatButton* itemFlatButton22 = new wxFlatButton(m_DlgPDL_Panel_Fields, ID_DLGPDL_FIELD_REMOVE,
                                                      wxFLATBUTTON_TEXT_REMOVE);
    itemBoxSizer20->Add(itemFlatButton22, 0, wxALIGN_CENTER_VERTICAL | wxRIGHT | wxTOP | wxBOTTOM, 5);

    m_DlgPDL_Orientation_FLD = new wxCheckBox(m_DlgPDL_Panel_Fields, ID_DLGPDL_CHK_ORIENTATION, _("Orientation field"));
    ...
    if (!m_bIsModeEditing) {
        m_DlgPDL_Contour_Static = new wxStaticBoxSizer(
            new wxStaticBox(itemDialog1, wxID_ANY, _("Polygon contour value")), wxVERTICAL);

        m_DlgPDL_Contour_Name = new wxTextCtrl(itemDialog1, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize,
                                               0);
    ...
    if (m_bIsModeEditing && !m_bIsModeAddingEditing) DisableControlsForEdition();
}
