...
bool ProjectDefDLG::CheckIdleRules() {
  ...
  if (m_DlgPd_Stat_Model_List->GetItemCount() < 1) return FALSE;
...
ProjectDefDLG::ProjectDefDLG(wxWindow *parent, PrjDefMemManage *myPrjDefinition, bool isEditingMode, wxWindowID id,
...
void ProjectDefDLG::CreateControls() {
  ...
  m_DlgPd_Proj_Projection = new wxChoice(m_DlgPd_Panel_Proj, ID_DLGPD_PROJ_PROJECTION, wxDefaultPosition, wxDefaultSize,
  ...
  m_DlgPd_Proj_Author =
      new wxTextCtrl(m_DlgPd_Panel_Proj, ID_DLGPD_PROJ_AUTHOR, _T(""), wxDefaultPosition, wxSize(300, -1), 0);
  ...
  if (m_bIsModeEditing) DisableControlsForEdition();
}
...
void ProjectDefList::BeforeAdding() {
  ...
  ProjectDefLayersDlg *myLayerDialog =
      new ProjectDefLayersDlg(this, m_pPrjDefinition, m_bIsModeEditing, m_bIsModeEditing);
