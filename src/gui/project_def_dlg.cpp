...
void ProjectDefDLG::CreateControls() {
    ...
    wxStaticText* itemStaticText17 = new wxStaticText(m_DlgPd_Panel_Proj, wxID_STATIC, _("Author :"), wxDefaultPosition,
                                                      wxDefaultSize, 0);
    itemFlexGridSizer16->Add(itemStaticText17, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);

    m_DlgPd_Proj_Author = new wxTextCtrl(m_DlgPd_Panel_Proj, ID_DLGPD_PROJ_AUTHOR, _T(""), wxDefaultPosition,
                                         wxSize(300, -1), 0);
...
void ProjectDefList::BeforeAdding() {
    ...
    ProjectDefLayersDlg* myLayerDialog = new ProjectDefLayersDlg(this, m_pPrjDefinition, m_bIsModeEditing,
                                                                 m_bIsModeEditing);
