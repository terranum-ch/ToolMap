...
tmSnapping_DLG::tmSnapping_DLG(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos,
    ...
    m_SnapBeginEndCtrl = new wxRadioButton(this, wxID_ANY, _("Begin / End vertex"), wxDefaultPosition, wxDefaultSize,
                                           0);
...
wxPanel* Snapping_PANEL::_CreateControls() {
    ...
    m_staticText5 = new wxStaticText(ContentFrame, wxID_ANY, _("Tolerance (meters):"), wxDefaultPosition, wxDefaultSize,
                                     0);
    m_staticText5->Wrap(-1);
    bSizer14->Add(m_staticText5, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    m_TolerenceCtrl = new wxSpinCtrl(ContentFrame, ID_SNAP_TOLERENCE_TXT, _T("10"), wxDefaultPosition, wxDefaultSize,
                                     wxSP_ARROW_KEYS, 1, 100000, 10);
    bSizer14->Add(m_TolerenceCtrl, 1, wxALL | wxEXPAND, 5);
    bSizer13->Add(bSizer14, 0, wxEXPAND, 5);

    m_ListCtrl = new DataListReportCtrl(ContentFrame, wxID_ANY, wxDefaultPosition, wxDefaultSize,
