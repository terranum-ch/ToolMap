...
DanglingNode_DLG::DanglingNode_DLG(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos,
...
void DanglingNode_DLG::CreateControls() {
  ...
  m_staticText6 =
      new wxStaticText(this, wxID_ANY, _("Search for dangling nodes on:"), wxDefaultPosition, wxDefaultSize, 0);
...
void DanglingNode_DLG::SetLayers(const wxArrayString &layers, int selected) {
