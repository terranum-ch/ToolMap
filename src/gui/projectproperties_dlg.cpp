...
void ProjectPropertiesDLG::_CreateControls() {
    ...
    wxPanel* itemPanel4 = new wxPanel(m_DLGPS_Notebook, ID_DLGPS_PANEL_SETTINGS, wxDefaultPosition, wxDefaultSize,
                                      wxTAB_TRAVERSAL);
    ...
    wxStaticText* itemStaticText8 = new wxStaticText(itemPanel4, wxID_STATIC, _("Export as :"), wxDefaultPosition,
                                                     wxDefaultSize, 0);
    ...
    m_DLGPS_Export_Type_Choice = new wxChoice(itemPanel4, ID_DLGPS_EXPORT_TYPE_CHOICE, wxDefaultPosition,
                                              wxSize(300, -1), m_DLGPS_Export_Type_ChoiceStrings, 0);
    ...
    wxStaticText* itemStaticText10 = new wxStaticText(itemPanel4, wxID_STATIC, _("Export Path :"), wxDefaultPosition,
                                                      wxDefaultSize, 0);
    ...
    wxStaticText* itemStaticText14 = new wxStaticText(itemPanel4, wxID_STATIC, _("Path :"), wxDefaultPosition,
                                                      wxDefaultSize, 0);
    ...
    wxPanel* itemPanel16 = new wxPanel(m_DLGPS_Notebook, ID_DLGPS_PANEL_SCALE, wxDefaultPosition, wxDefaultSize,
                                       wxTAB_TRAVERSAL);
    ...
    wxStaticText* itemStaticText22 = new wxStaticText(itemPanel16, wxID_STATIC, _("Order :"), wxDefaultPosition,
                                                      wxDefaultSize, 0);
    itemBoxSizer19->Add(itemStaticText22, 0, wxALIGN_CENTER_VERTICAL | wxALL, 5);

    m_DLGPS_Scale_Order_Choice = new wxChoice(
        itemPanel16, ID_DLGPS_SCALE_ORDER_CHOICE, wxDefaultPosition, wxDefaultSize,
    ...
    wxStaticLine* itemStaticLine24 = new wxStaticLine(itemDialog1, wxID_STATIC, wxDefaultPosition, wxDefaultSize,
                                                      wxLI_HORIZONTAL);
...
void ScaleList::BeforeAdding() {
    ...
    wxNumberEntryDialog* myScaleDialog = new wxNumberEntryDialog(this, _("Add a new scale"), _T("1:"),
                                                                 _("Adding new scale"), 1, 1, 999999999);
