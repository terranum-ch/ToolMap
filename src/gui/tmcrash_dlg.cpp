...
void tmCrash_DLG::CreateControls(wxWindow *parent)
{
    ...
    m_staticText22 = new wxStaticText(this, wxID_ANY,
                                      _("ToolMap has encountered an unexpected problem and will close. "),
                                      wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE);
    m_staticText22->Wrap(-1);
    bSizer45->Add(m_staticText22, 0, wxALL | wxALIGN_CENTER_HORIZONTAL, 5);

    wxStaticText *m_staticText23;
    m_staticText23 = new wxStaticText(this, wxID_ANY,
                                      _("Informations about the crash has been successfully collected here :  "),
                                      wxDefaultPosition, wxDefaultSize, 0);
    m_staticText23->Wrap(-1);
    bSizer45->Add(m_staticText23, 0, wxALL | wxALIGN_CENTER_HORIZONTAL, 5);

    m_CrashFile = new wxTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize,
                                 wxTE_CENTRE | wxTE_READONLY);
    bSizer45->Add(m_CrashFile, 0, wxALL | wxEXPAND, 5);

    wxStaticText *m_staticText24;
    m_staticText24 = new wxStaticText(this, wxID_ANY,
                                      _("Please report this bug using the button bellow. \nReported informations will be used for improving ToolMap's quality.   "),
                                      wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE);
