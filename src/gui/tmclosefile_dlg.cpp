...
tmCloseFile_DLG::tmCloseFile_DLG( wxWindow* parent, const wxArrayString & choices, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style ){
    _CreateControls();
