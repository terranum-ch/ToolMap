...
void PreferenceDLG::_CreateControls() {
    ...
    m_SelColourCtrl = new wxColourPickerCtrl(m_panel2, wxID_ANY, *wxBLACK, wxDefaultPosition, wxDefaultSize,
    ...
    m_UpdateCheckCtrl = new wxCheckBox(m_panel3, wxID_ANY, _("Check for updates at startup"), wxDefaultPosition,
                                       wxDefaultSize, 0);
    ...
    m_ctrl_debug_error = new wxCheckBox(m_panel_debug, wxID_ANY, _("Log database errors"), wxDefaultPosition,
                                        wxDefaultSize, 0);
