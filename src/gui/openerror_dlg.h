...
class tmOpenError_DLG : public wxDialog {
  ...
  public:
    tmOpenError_DLG(wxWindow* parent, int iActDBVersion, const wxString& projname, DataBaseTM* database,
...
class tmOpenRecentError_DLG : public wxDialog {
  ...
  public:
    tmOpenRecentError_DLG(wxWindow* parent, wxWindowID id, const wxString& title, const wxString& prjname,
