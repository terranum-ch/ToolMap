...
void tmOpenError_DLG::_CreateControls(const wxString &projname, int iActDBVersion) {
  ...
  wxString myErrTxt2 =
      wxString::Format(_("This project was created with an older version of ToolMap. It must be updated before "
  ...
  m_ErrVerConvertCtrl =
      new wxButton(m_ErrPanelProjVersion, wxID_ANY, _("Convert and open..."), wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxString myErrTxt3 =
      _("This project was created with a newer version of ToolMap. It is not supported by the installed version of "
...
tmOpenError_DLG::~tmOpenError_DLG() {
  m_ErrVerBackupConvertCtrl->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                                        wxCommandEventHandler(tmOpenError_DLG::OnConvertBackup), NULL, this);
  m_ErrVerConvertCtrl->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(tmOpenError_DLG::OnConvert), NULL,
                                  this);
