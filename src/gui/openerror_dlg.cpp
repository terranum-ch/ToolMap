...
void tmOpenError_DLG::_CreateControls(const wxString &projname, int iActDBVersion)
{
    ...
    wxString myErrTxt3 = _(
            "This project was created with a newer version of ToolMap. It is not supported by the installed version of ToolMap.\nPlease consider updating ToolMap to a newer version.");
