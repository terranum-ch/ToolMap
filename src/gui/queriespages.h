...
class QueriesPageObjectType : public wxWizardPageSimple {
 ...
 public:
  QueriesPageObjectType(QueriesWizard *parent, DataBaseTM *database, wxWizardPage *prev, wxWizardPage *next);
...
class QueriesPageAttribut2 : public wxWizardPageSimple {
 ...
 public:
  QueriesPageAttribut2(QueriesWizard *parent, DataBaseTM *database, wxWizardPageSimple *prev, wxWizardPageSimple *next);
...
class QueriesPageGeomLine : public wxWizardPageSimple {
 ...
 public:
  QueriesPageGeomLine(QueriesWizard *parent, DataBaseTM *database, wxWizardPage *prev, wxWizardPage *next);
...
class QueriesPageGeomNodes : public wxWizardPageSimple {
 ...
 public:
  QueriesPageGeomNodes(QueriesWizard *parent, DataBaseTM *database, wxWizardPage *prev, wxWizardPage *next);
