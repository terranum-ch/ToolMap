...
tmWizardImport::tmWizardImport(wxWindow* parent, wxWindowID id, const wxString& title, const wxBitmap& bitmap,
  ...
  m_radioBtnSHP =
      new wxRadioButton(m_wizPageFileType, wxID_ANY, wxT("ESRI's shapefile"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticText3 =
      new wxStaticText(m_wizPageFilePath, wxID_ANY, wxT("Select the file"), wxDefaultPosition, wxSize(-1, 25), 0);
  ...
  m_infoLabelCtrl1 =
      new wxStaticText(sbSizer1->GetStaticBox(), wxID_ANY, wxT("MyLabel"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticText9 =
      new wxStaticText(m_wizPageXY, wxID_ANY, wxT("Select X/Y columns"), wxDefaultPosition, wxSize(-1, 25), 0);
  ...
  m_staticText91 =
      new wxStaticText(m_wizPageTarget, wxID_ANY, wxT("Select target"), wxDefaultPosition, wxSize(-1, 25), 0);
  ...
  m_staticText101 =
      new wxStaticText(m_wizPageTarget, wxID_ANY, wxT("Import into:"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_staticText13 =
      new wxStaticText(m_wizPageLayer, wxID_ANY, wxT("Select layer"), wxDefaultPosition, wxSize(-1, 25), 0);
  ...
  m_scrolledWindow3 =
      new wxScrolledWindow(m_wizPageKindMatch, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL | wxVSCROLL);
  ...
  m_staticText14 =
      new wxStaticText(m_wizPageAttributes, wxID_ANY, wxT("Attributes matching"), wxDefaultPosition, wxSize(-1, 25), 0);
  ...
  m_scrolledWindow1 =
      new wxScrolledWindow(m_wizPageAttributes, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL | wxVSCROLL);
  ...
  m_staticText141 =
      new wxStaticText(m_wizPageEnums, wxID_ANY, wxT("Enumerations matching"), wxDefaultPosition, wxSize(-1, 25), 0);
  ...
  m_scrolledWindow2 =
      new wxScrolledWindow(m_wizPageEnums, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHSCROLL | wxVSCROLL);
