...
tmWizardImport::tmWizardImport(wxWindow* parent, wxWindowID id, const wxString& title, const wxBitmap& bitmap,
    ...
    m_staticText1 = new wxStaticText(m_wizPageFileType, wxID_ANY, wxT("Select the type of file"), wxDefaultPosition,
                                     wxSize(-1, 25), 0);
    m_staticText1->Wrap(-1);
    m_staticText1->SetFont(
        wxFont(13, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString));

    bSizer1->Add(m_staticText1, 0, wxALL, 5);

    m_radioBtnSHP = new wxRadioButton(m_wizPageFileType, wxID_ANY, wxT("ESRI's shapefile"), wxDefaultPosition,
                                      wxDefaultSize, 0);
    bSizer1->Add(m_radioBtnSHP, 0, wxALL, 5);

    m_radioBtnCSV = new wxRadioButton(m_wizPageFileType, wxID_ANY, wxT("CSV file"), wxDefaultPosition, wxDefaultSize,
                                      0);
    ...
    m_staticText3 = new wxStaticText(m_wizPageFilePath, wxID_ANY, wxT("Select the file"), wxDefaultPosition,
                                     wxSize(-1, 25), 0);
    ...
    m_filePicker = new wxFilePickerCtrl(m_wizPageFilePath, wxID_ANY, wxEmptyString, wxT("Select a file"), wxT("*.*"),
    ...
    m_infoLabelCtrl1 = new wxStaticText(sbSizer1->GetStaticBox(), wxID_ANY, wxT("MyLabel"), wxDefaultPosition,
                                        wxDefaultSize, 0);
    m_infoLabelCtrl1->Wrap(-1);
    fgSizer1->Add(m_infoLabelCtrl1, 0, wxALL, 5);

    m_infoValueCtrl1 = new wxStaticText(sbSizer1->GetStaticBox(), wxID_ANY, wxT("MyLabel"), wxDefaultPosition,
                                        wxDefaultSize, 0);
    m_infoValueCtrl1->Wrap(-1);
    fgSizer1->Add(m_infoValueCtrl1, 0, wxALL, 5);

    m_infoLabelCtrl2 = new wxStaticText(sbSizer1->GetStaticBox(), wxID_ANY, wxT("MyLabel"), wxDefaultPosition,
                                        wxDefaultSize, 0);
    m_infoLabelCtrl2->Wrap(-1);
    fgSizer1->Add(m_infoLabelCtrl2, 0, wxALL, 5);

    m_infoValueCtrl2 = new wxStaticText(sbSizer1->GetStaticBox(), wxID_ANY, wxT("MyLabel"), wxDefaultPosition,
                                        wxDefaultSize, 0);
    ...
    m_staticText9 = new wxStaticText(m_wizPageXY, wxID_ANY, wxT("Select X/Y columns"), wxDefaultPosition,
                                     wxSize(-1, 25), 0);
    m_staticText9->Wrap(-1);
    m_staticText9->SetFont(
        wxFont(13, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString));
    ...
    m_staticText11 = new wxStaticText(sbSizer2->GetStaticBox(), wxID_ANY, wxT("X:"), wxDefaultPosition, wxDefaultSize,
                                      0);
    ...
    m_staticText12 = new wxStaticText(sbSizer2->GetStaticBox(), wxID_ANY, wxT("Y:"), wxDefaultPosition, wxDefaultSize,
                                      0);
    ...
    m_staticText91 = new wxStaticText(m_wizPageTarget, wxID_ANY, wxT("Select target"), wxDefaultPosition,
                                      wxSize(-1, 25), 0);
    m_staticText91->Wrap(-1);
    m_staticText91->SetFont(
        wxFont(13, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString));
    ...
    m_staticText101 = new wxStaticText(m_wizPageTarget, wxID_ANY, wxT("Import into:"), wxDefaultPosition, wxDefaultSize,
                                       0);
    m_staticText101->Wrap(-1);
    bSizer41->Add(m_staticText101, 0, wxALL | wxALIGN_CENTER_VERTICAL, 5);

    wxArrayString m_choiceTargetChoices;
    m_choiceTarget = new wxChoice(m_wizPageTarget, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_choiceTargetChoices,
                                  0);
    ...
    m_staticText13 = new wxStaticText(m_wizPageLayer, wxID_ANY, wxT("Select layer"), wxDefaultPosition, wxSize(-1, 25),
                                      0);
    m_staticText13->Wrap(-1);
    m_staticText13->SetFont(
        wxFont(13, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString));
    ...
    m_staticText15 = new wxStaticText(m_wizPageKindField, wxID_ANY, wxT("Select object kind field in file"),
                                      wxDefaultPosition, wxSize(-1, 25), 0);
    m_staticText15->Wrap(-1);
    m_staticText15->SetFont(
        wxFont(13, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString));
    ...
    m_checkBoxAllSameKind = new wxCheckBox(m_wizPageKindField, wxID_ANY, wxT("Assign all objects to the same kind"),
    ...
    m_staticText16 = new wxStaticText(m_wizPageKindMatch, wxID_ANY, wxT("Object kinds matching"), wxDefaultPosition,
                                      wxSize(-1, 25), 0);
    m_staticText16->Wrap(-1);
    m_staticText16->SetFont(
        wxFont(13, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString));

    bSizer10->Add(m_staticText16, 0, wxALL, 5);

    m_scrolledWindow3 = new wxScrolledWindow(m_wizPageKindMatch, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                             wxHSCROLL | wxVSCROLL);
    ...
    m_staticText14 = new wxStaticText(m_wizPageAttributes, wxID_ANY, wxT("Attributes matching"), wxDefaultPosition,
                                      wxSize(-1, 25), 0);
    m_staticText14->Wrap(-1);
    m_staticText14->SetFont(
        wxFont(13, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString));

    bSizer6->Add(m_staticText14, 0, wxALL, 5);

    m_scrolledWindow1 = new wxScrolledWindow(m_wizPageAttributes, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                             wxHSCROLL | wxVSCROLL);
    ...
    m_staticText141 = new wxStaticText(m_wizPageEnums, wxID_ANY, wxT("Enumerations matching"), wxDefaultPosition,
                                       wxSize(-1, 25), 0);
    m_staticText141->Wrap(-1);
    m_staticText141->SetFont(
        wxFont(13, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString));

    bSizer61->Add(m_staticText141, 0, wxALL, 5);

    m_scrolledWindow2 = new wxScrolledWindow(m_wizPageEnums, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                             wxHSCROLL | wxVSCROLL);
...
tmWizardImport::~tmWizardImport() {
    ...
    m_filePicker->Disconnect(wxEVT_COMMAND_FILEPICKER_CHANGED,
                             wxFileDirPickerEventHandler(tmWizardImport::OnFileChanged), nullptr, this);
