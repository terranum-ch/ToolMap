...
BezierSettings_DLG::BezierSettings_DLG(wxWindow* parent, tmEditManager* editmanager, tmRenderer* renderer,
    ...
    m_PreviewCtrl->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(BezierSettings_DLG::OnCheckPreview),
                           nullptr, this);
    m_PreviewCtrl->Connect(wxEVT_UPDATE_UI, wxUpdateUIEventHandler(BezierSettings_DLG::OnUpdateUIPreview), nullptr,
                           this);
}
...
BezierSettings_DLG::~BezierSettings_DLG() {
    ...
    m_PreviewCtrl->Disconnect(wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(BezierSettings_DLG::OnCheckPreview),
                              nullptr, this);
    m_PreviewCtrl->Disconnect(wxEVT_UPDATE_UI, wxUpdateUIEventHandler(BezierSettings_DLG::OnUpdateUIPreview), nullptr,
                              this);
}
...
void BezierSettings_DLG::_CreateControls() {
    ...
    m_staticText2 = new wxStaticText(m_panel1, wxID_ANY,
                                     _("A high scale value implies high accuracy\nand a large number of vertices"),
                                     wxDefaultPosition, wxDefaultSize, 0);
    m_staticText2->Wrap(-1);
    sbSizer1->Add(m_staticText2, 0, wxALL, 5);

    m_ApproximationCtrl = new wxSpinCtrlDouble(m_panel1, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(100, -1),
                                               wxSP_ARROW_KEYS, 0, 10, 0, 0.1);
    ...
    m_WidthToleranceCtrl = new wxSpinCtrlDouble(m_panel2, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(100, -1),
    ...
    m_MaxNumPointsCtrl = new wxSpinCtrl(m_panel2, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(100, -1),
