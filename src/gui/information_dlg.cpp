...
wxMenu* tmSelectionInfoCtrl::_CreatePopupMenu() {
    ...
    m_menuItem9 = new wxMenuItem(myMenu, ID_POPUP_REMOVE_FROM_SEL, wxString(wxT("Remove from selection")),
    ...
    m_menuItem11 = new wxMenuItem(myMenu, wxID_COPY, wxString(wxT("Copy data to clipboard")), wxEmptyString,
                                  wxITEM_NORMAL);
