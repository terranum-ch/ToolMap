...
wxSizer *AttribObjType_PANEL::CreateControls(wxWindow *parent, bool call_fit, bool set_sizer) {
  ...
  wxAuiNotebook *itemNotebook1 =
      new wxAuiNotebook(itemPanel1, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxAUI_NB_TOP);
  ...
  wxAuiNotebook *itemNotebook2 =
      new wxAuiNotebook(itemPanel4, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxAUI_NB_TOP);
  ...
  wxAuiNotebook *itemNotebook3 =
      new wxAuiNotebook(itemPanel7, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxAUI_NB_TOP);
