...
AttribObjType_PANEL::AttribObjType_PANEL(wxWindow* parent, wxAuiManager* AuiManager)
    ...
    // Connect events
    m_textCtrlPoints->Connect(wxEVT_SET_FOCUS, wxFocusEventHandler(AttribObjType_PANEL::SetFocusTextCtrl), nullptr,
                              this);
    m_textCtrlPoints->Connect(wxEVT_KILL_FOCUS, wxFocusEventHandler(AttribObjType_PANEL::KillFocusTextCtrl), nullptr,
                              this);
    ...
    m_textCtrlPoly->Connect(wxEVT_KILL_FOCUS, wxFocusEventHandler(AttribObjType_PANEL::KillFocusTextCtrl), nullptr,
                            this);
    m_textCtrlPoly->Connect(wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler(AttribObjType_PANEL::FilterPolyList),
                            nullptr, this);
    m_textCtrlLines->Connect(wxEVT_SET_FOCUS, wxFocusEventHandler(AttribObjType_PANEL::SetFocusTextCtrl), nullptr,
                             this);
    m_textCtrlLines->Connect(wxEVT_KILL_FOCUS, wxFocusEventHandler(AttribObjType_PANEL::KillFocusTextCtrl), nullptr,
                             this);
    m_textCtrlLines->Connect(wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler(AttribObjType_PANEL::FilterLineList),
                             nullptr, this);
}

AttribObjType_PANEL::~AttribObjType_PANEL() {
    // Disconnect events
    m_textCtrlPoints->Disconnect(wxEVT_SET_FOCUS, wxFocusEventHandler(AttribObjType_PANEL::SetFocusTextCtrl), nullptr,
                                 this);
    m_textCtrlPoints->Disconnect(wxEVT_KILL_FOCUS, wxFocusEventHandler(AttribObjType_PANEL::KillFocusTextCtrl), nullptr,
                                 this);
    m_textCtrlPoints->Disconnect(wxEVT_COMMAND_TEXT_UPDATED,
                                 wxCommandEventHandler(AttribObjType_PANEL::FilterPointList), nullptr, this);
    m_textCtrlPoly->Disconnect(wxEVT_SET_FOCUS, wxFocusEventHandler(AttribObjType_PANEL::SetFocusTextCtrl), nullptr,
                               this);
    m_textCtrlPoly->Disconnect(wxEVT_KILL_FOCUS, wxFocusEventHandler(AttribObjType_PANEL::KillFocusTextCtrl), nullptr,
                               this);
    m_textCtrlPoly->Disconnect(wxEVT_COMMAND_TEXT_UPDATED, wxCommandEventHandler(AttribObjType_PANEL::FilterPolyList),
                               nullptr, this);
    m_textCtrlLines->Disconnect(wxEVT_SET_FOCUS, wxFocusEventHandler(AttribObjType_PANEL::SetFocusTextCtrl), nullptr,
                                this);
    m_textCtrlLines->Disconnect(wxEVT_KILL_FOCUS, wxFocusEventHandler(AttribObjType_PANEL::KillFocusTextCtrl), nullptr,
                                this);
...
wxSizer* AttribObjType_PANEL::CreateControls(wxWindow* parent, bool call_fit, bool set_sizer) {
    ...
    wxAuiNotebook* itemNotebook1 = new wxAuiNotebook(itemPanel1, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                                     wxAUI_NB_TOP);
    ...
    m_pObjList_L_Freq = new tmCheckListBoxRank(itemPanel2, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, nullptr,
                                               tmLB_MENU);
    ...
    m_pObjList_L_NoFreq = new tmCheckListBoxRank(itemPanel3, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, nullptr,
                                                 tmLB_MENU);
    ...
    wxPanel* itemPanel4 = new wxPanel(m_AttribNotebook, wxID_ANY, wxDefaultPosition, wxSize(300, 300), wxTAB_TRAVERSAL);
    ...
    m_pObjList_PT_Freq = new tmCheckListBoxRank(itemPanel5, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, nullptr,
                                                tmLB_MENU);
    ...
    m_pObjList_PT_NoFreq = new tmCheckListBoxRank(itemPanel6, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, nullptr,
                                                  tmLB_MENU);
    ...
    wxPanel* itemPanel7 = new wxPanel(m_AttribNotebook, wxID_ANY, wxDefaultPosition, wxSize(300, 300), wxTAB_TRAVERSAL);
    ...
    m_pObjList_PLG_Freq = new tmCheckListBoxRank(itemPanel8, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, nullptr,
                                                 tmLB_MENU);
    ...
    m_pObjList_PLG_NoFreq = new tmCheckListBoxRank(itemPanel9, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0, nullptr,
                                                   tmLB_MENU);
    ...
    wxStaticText* itemStaticText27 = new wxStaticText(itemPanel24, wxID_STATIC, _("Priority :"), wxDefaultPosition,
                                                      wxDefaultSize, 0);
    ...
    wxChoice* itemChoice28 = new wxChoice(itemPanel24, ID_CHOICE13, wxDefaultPosition, wxDefaultSize,
                                          itemChoice28Strings, 0);
    itemChoice28->SetStringSelection(_("High"));
    itemFlexGridSizer26->Add(itemChoice28, 0, wxGROW | wxALIGN_CENTER_VERTICAL, 0);

    wxStaticText* itemStaticText29 = new wxStaticText(itemPanel24, wxID_STATIC, _("Author :"), wxDefaultPosition,
                                                      wxDefaultSize, 0);
    itemFlexGridSizer26->Add(itemStaticText29, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxTOP, 5);

    wxTextCtrl* itemTextCtrl30 = new wxTextCtrl(itemPanel24, ID_TEXTCTRL19, _T(""), wxDefaultPosition, wxDefaultSize,
                                                0);
    itemFlexGridSizer26->Add(itemTextCtrl30, 0, wxGROW | wxALIGN_CENTER_VERTICAL | wxTOP, 5);

    wxStaticText* itemStaticText31 = new wxStaticText(itemPanel24, wxID_STATIC, _("Code :"), wxDefaultPosition,
                                                      wxDefaultSize, 0);
    ...
    wxChoice* itemChoice32 = new wxChoice(itemPanel24, ID_CHOICE14, wxDefaultPosition, wxDefaultSize,
                                          itemChoice32Strings, 0);
    itemChoice32->SetStringSelection(_("Error"));
    itemFlexGridSizer26->Add(itemChoice32, 0, wxGROW | wxALIGN_CENTER_VERTICAL | wxTOP, 5);

    wxStaticText* itemStaticText33 = new wxStaticText(itemPanel24, wxID_STATIC, _("Date :"), wxDefaultPosition,
                                                      wxDefaultSize, 0);
    itemFlexGridSizer26->Add(itemStaticText33, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);

    wxDatePickerCtrl* itemDatePickerCtrl34 = new wxDatePickerCtrl(
        itemPanel24, ID_DATEPICKERCTRL);  //, wxDateTime(), wxDefaultPosition, wxDefaultSize, wxDP_DEFAULT );
    ...
    wxTextCtrl* itemTextCtrl36 = new wxTextCtrl(itemPanel24, ID_TEXTCTRL21, _T(""), wxDefaultPosition, wxDefaultSize,
                                                wxTE_MULTILINE);
    itemStaticBoxSizer35->Add(itemTextCtrl36, 1, wxGROW, 0);

    wxCheckBox* itemCheckBox37 = new wxCheckBox(itemPanel24, ID_CHECKBOX7, _("fixed"), wxDefaultPosition, wxDefaultSize,
                                                0);
    ...
    if (set_sizer) {
        ...
        if (call_fit) m_AttribSizer->SetSizeHints(parent);
    }
...
bool AttribObjType_PANEL::UpdateObjectPointList(DataBaseTM* pDB) {
    ...
    if (!UpdateObjectList(pDB, m_pObjList_PT_Freq, LAYER_POINT, OBJECT_FREQUENT)) return FALSE;

    if (!UpdateObjectList(pDB, m_pObjList_PT_NoFreq, LAYER_POINT, OBJECT_LESS_FREQUENT)) return FALSE;
...
bool AttribObjType_PANEL::UpdateObjectPolyList(DataBaseTM* pDB) {
    ...
    if (!UpdateObjectList(pDB, m_pObjList_PLG_Freq, LAYER_POLYGON, OBJECT_FREQUENT)) return FALSE;

    if (!UpdateObjectList(pDB, m_pObjList_PLG_NoFreq, LAYER_POLYGON, OBJECT_LESS_FREQUENT)) return FALSE;
...
bool AttribObjType_PANEL::UpdateObjectLineList(DataBaseTM* pDB) {
    ...
    if (!UpdateObjectList(pDB, m_pObjList_L_Freq, LAYER_LINE, OBJECT_FREQUENT)) return FALSE;

    if (!UpdateObjectList(pDB, m_pObjList_L_NoFreq, LAYER_LINE, OBJECT_LESS_FREQUENT)) return FALSE;
...
/***************************************************************************/ /**
  ...
  @date 16 May 2008
  *******************************************************************************/
bool AttribObjType_PANEL::UpdateObjectList(DataBaseTM* pDB, tmCheckListBox* pList, int type, short frequency) {
    // check database
    if (!pDB) {
    ...
    while (1) {
        if (pDB->DataBaseGetNextResultAsObject(&myTempObject, type)) {
            if (frequency == myTempObject.m_ObjectFreq) {
                pList->AddItem(-1, myTempObject.m_ObjectID, myTempObject.m_ObjectName);
            }
