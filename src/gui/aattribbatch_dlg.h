...
class tmAAttribInfoPanel : public tmAAttribCtrl {
 ...
 public:
  ...
  tmAAttribInfoPanel(wxWindow *parent, const ProjectDefMemoryFields &fieldinfo, wxWindowID id = wxID_ANY,
                     const wxPoint &pos = wxDefaultPosition, const wxSize &size = wxDefaultSize,
                     long style = wxTAB_TRAVERSAL, const wxString &name = _T("tmAAttribInfoPanel")) {
  ...
  void Create(wxWindow *parent, const ProjectDefMemoryFields &fieldinfo, wxWindowID id = wxID_ANY,
    ...
    m_Label = new wxStaticText(this, wxID_ANY, _("Hint: "), wxDefaultPosition, wxDefaultSize, 0);
    ...
    m_ControlInfo = new wxStaticText(
        this, wxID_ANY, _("Select an object type then a field to be able to set value to selected objects"));
...
class AAttribBatch_DLG : public wxDialog {
 ...
 public:
  AAttribBatch_DLG(wxWindow *parent, tmAAttribBatchManager *manager, wxWindowID id = wxID_ANY,
