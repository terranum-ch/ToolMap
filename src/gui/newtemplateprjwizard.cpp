...
void NewTemplatePrjWizard::_CreateControls() {
    ...
    wxStaticText* m_staticText1 = new wxStaticText(m_SourcePage, wxID_ANY, _("Select a template File: "),
                                                   wxDefaultPosition, wxDefaultSize, 0);
    m_staticText1->Wrap(-1);
    bSizer1->Add(m_staticText1, 0, wxALL, 5);

    m_SourceFileCtrl = new wxFilePickerCtrl(
        m_SourcePage, ID_NEWPRJ_SOURCEDIRCTRL, wxEmptyString, _("Select a template file"),
        _("ToolMap template files(*.tmtp)|*.tmtp|ToolMap backup files (*.tmbk)|*.tmbk"), wxDefaultPosition,
        wxSize(200, -1), wxFLP_DEFAULT_STYLE);
    ...
    wxStaticText* m_staticText5 = new wxStaticText(m_SourcePage, wxID_ANY, _("Date:"), wxDefaultPosition, wxDefaultSize,
                                                   0);
    ...
    wxStaticText* m_staticText4 = new wxStaticText(m_SourcePage, wxID_ANY, _("Comment:"), wxDefaultPosition,
                                                   wxDefaultSize, 0);
    ...
    sbSizer1 = new wxStaticBoxSizer(new wxStaticBox(m_DestinationPage, wxID_ANY, wxT("New project information ")),
                                    wxVERTICAL);
    ...
    m_DestNameCtrl = new wxTextCtrl(m_DestinationPage, ID_NEWPRJ_DESTNAMECTRL, wxEmptyString, wxDefaultPosition,
                                    wxDefaultSize, 0);
