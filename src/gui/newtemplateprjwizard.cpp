...
void NewTemplatePrjWizard::_CreateControls() {
	...
	wxStaticText * m_staticText1 = new wxStaticText( m_SourcePage, wxID_ANY, _("Select a template File: "), wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer1 = new wxStaticBoxSizer( new wxStaticBox( m_DestinationPage, wxID_ANY, wxT("New project information ") ), wxVERTICAL );
