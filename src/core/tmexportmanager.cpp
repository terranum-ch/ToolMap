...
bool tmExportManager::ExportConcatenated(PrjDefMemManage *localprojdef, PRJDEF_LAYERS_TYPE type, bool useProgressDlg) {
  ...
  if (useProgressDlg) {
    myProgressDlg = new wxProgressDialog(
        ...
        m_Parent, wxPD_APP_MODAL | wxPD_CAN_ABORT | wxPD_AUTO_HIDE);
  }
...
void tmExportSelected_DLG::_CreateControls(const wxArrayString &layers) {
  ...
  m_FastPolyExportCtrl =
      new wxCheckBox(this, wxID_ANY, _("Use Fast Polygon export"), wxDefaultPosition, wxDefaultSize, 0);
  m_FastPolyExportCtrl->SetValue(myConfig->ReadBool("use_fast_polygon", true));
  sbSizer2->Add(m_FastPolyExportCtrl, 0, wxALL, 5);

  m_ExportEmptyLayersCtrl =
      new wxCheckBox(this, wxID_ANY, _("Export empty layers"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_ExportAttribDescCtrl =
      new wxRadioButton(this, wxID_ANY, _("Export description"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
