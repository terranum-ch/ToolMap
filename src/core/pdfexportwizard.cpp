...
void PdfExportWizard::_CreateControls() {
  ...
  m_ExportOnePageCtrl =
      new wxRadioButton(m_panel1, wxID_ANY, _("One Page"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
  m_ExportOnePageCtrl->SetValue(true);
  sbSizer1->Add(m_ExportOnePageCtrl, 0, wxALL, 5);

  m_ExportMultiPageCtrl =
      new wxRadioButton(m_panel1, wxID_ANY, _("One layer per page"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_ExportOneColCtrl =
      new wxRadioButton(m_panel2, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
  ...
  wxStaticText *m_staticText1 =
      new wxStaticText(m_panel2, wxID_ANY, _("Object Kind"), wxDefaultPosition, wxDefaultSize, 0);
  m_staticText1->Wrap(-1);
  bSizer5->Add(m_staticText1, 0, wxTOP | wxRIGHT, 5);

  wxStaticText *m_staticText2 =
      new wxStaticText(m_panel2, wxID_ANY, _("Object Attribute"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_ExportTwoColCtrl =
      new wxRadioButton(m_panel2, wxID_ANY, _("Object Kind / Object Attribute"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_PaperPortraitCtrl =
      new wxRadioButton(m_PagePaper, wxID_ANY, _("Portrait"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
  ...
  m_DecorationSimpleCtrl =
      new wxCheckBox(m_PageDecoration, wxID_ANY, _("Use very simple decorations"), wxDefaultPosition, wxDefaultSize, 0);
