...
void ToolMapFrame::OnExportProjectModel (wxCommandEvent & event){
	...
	pdf.Cell(90,10,_("Project"), wxPDF_BORDER_BOTTOM, 1);
	pdf.SetFont(wxT("Helvetica"),wxT("I"),12);
	pdf.Cell(0,10,wxString::Format(_("Automatically generated by ToolMap: %s"), wxDateTime::Now().FormatISOCombined(' ')), wxPDF_BORDER_NONE, 1);
	pdf.Line(0,0,50, 50);
	pdf.SaveAsFile(myFileTxtName);
	*/
