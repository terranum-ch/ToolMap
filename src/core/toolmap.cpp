...
void ToolMapFrame::OnOpenProject(wxCommandEvent &event) {
  ...
  wxDirDialog *myDirDLG =
      new wxDirDialog(this, _("Choose a ToolMap project"), _T(""), wxRESIZE_BORDER | wxDD_DIR_MUST_EXIST);
...
void ToolMapFrame::OnExportProjectModel(wxCommandEvent &event) {
  ...
  wxString myFileTxtName =
      wxFileSelector(_("Export Model as PDF"), wxEmptyString, m_PManager->GetMemoryProjectDefinition()->m_PrjName,
                     "pdf", _("PDF files (*.pdf)|*.pdf"), wxFD_SAVE | wxFD_OVERWRITE_PROMPT, this);
