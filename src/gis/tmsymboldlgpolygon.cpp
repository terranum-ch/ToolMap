...
tmSymbolDLGPolygon::tmSymbolDLGPolygon(wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos,
                                       const wxSize& size, long style) {
    _Init();
    Create(parent, id, caption, pos, size, style);
}

bool tmSymbolDLGPolygon::Create(wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos,
                                const wxSize& size, long style) {
...
void tmSymbolDLGPolygon::CreateControlsPoly() {
    ...
    wxStaticText* itemStaticText12 = new wxStaticText(m_SymbolPanel, wxID_STATIC, _("Border Color :"),
    ...
    wxStaticText* itemStaticText14 = new wxStaticText(m_SymbolPanel, wxID_STATIC, _("Border Width :"),
                                                      wxDefaultPosition, wxDefaultSize, 0);
    itemFlexGridSizer11->Add(itemStaticText14, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);

    m_PolygonBorderWidthCtrl = new wxSpinCtrl(m_SymbolPanel, ID_SYMDLGPLG_BORDER_WIDTH, _T("0"), wxDefaultPosition,
    ...
    wxStaticText* itemStaticText16 = new wxStaticText(m_SymbolPanel, wxID_STATIC, _("Fill Color :"), wxDefaultPosition,
                                                      wxDefaultSize, 0);
    ...
    wxStaticText* itemStaticText18 = new wxStaticText(m_SymbolPanel, wxID_STATIC, _("Fill style :"), wxDefaultPosition,
                                                      wxDefaultSize, 0);
    itemFlexGridSizer11->Add(itemStaticText18, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);

    m_PolygonFillPattern = new wxChoice(m_SymbolPanel, ID_SYMDLGPLG_FILL_PATTERN, wxDefaultPosition, wxDefaultSize,
                                        (sizeof(tmSYMBOLFILLSTYLES_NAME) / sizeof(wxString)), tmSYMBOLFILLSTYLES_NAME,
                                        0);
    ...
    m_TransparencySlider = new tmSliderWithText(m_SymbolPanel, ID_SYMDLGPLG_TRANSPARENCY, 0, 0, 100, _T("%"));
...
void tmSymbolDLGPolyRule::_CreateControls() {
    ...
    wxStaticText* itemStaticText12 = new wxStaticText(m_panel2, wxID_STATIC, _("Border Color :"), wxDefaultPosition,
                                                      wxDefaultSize, 0);
    itemFlexGridSizer11->Add(itemStaticText12, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);
    ...
    wxStaticText* itemStaticText14 = new wxStaticText(m_panel2, wxID_STATIC, _("Border Width :"), wxDefaultPosition,
                                                      wxDefaultSize, 0);
    itemFlexGridSizer11->Add(itemStaticText14, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);

    m_PolygonBorderWidthCtrl = new wxSpinCtrl(m_panel2, ID_SYMDLGPLG_BORDER_WIDTH, _T("0"), wxDefaultPosition,
                                              wxDefaultSize, wxSP_ARROW_KEYS, 0, 100, 0);
    itemFlexGridSizer11->Add(m_PolygonBorderWidthCtrl, 0, wxGROW | wxALIGN_CENTER_VERTICAL | wxALL, 5);

    wxStaticText* itemStaticText16 = new wxStaticText(m_panel2, wxID_STATIC, _("Fill Color :"), wxDefaultPosition,
                                                      wxDefaultSize, 0);
    itemFlexGridSizer11->Add(itemStaticText16, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);
    ...
    wxStaticText* itemStaticText18 = new wxStaticText(m_panel2, wxID_STATIC, _("Fill style :"), wxDefaultPosition,
                                                      wxDefaultSize, 0);
    itemFlexGridSizer11->Add(itemStaticText18, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);

    m_PolygonFillPattern = new wxChoice(m_panel2, ID_SYMDLGPLG_FILL_PATTERN, wxDefaultPosition, wxDefaultSize,
                                        (sizeof(tmSYMBOLFILLSTYLES_NAME) / sizeof(wxString)), tmSYMBOLFILLSTYLES_NAME,
                                        0);
    itemFlexGridSizer11->Add(m_PolygonFillPattern, 0, wxGROW | wxALIGN_CENTER_VERTICAL | wxALL, 5);
    ...
    m_TransparencySlider = new tmSliderWithText(m_panel2, ID_SYMDLGPLG_TRANSPARENCY, 0, 0, 100, _T("%"));
    itemStaticBoxSizer26->Add(m_TransparencySlider, 1, wxGROW | wxALL, 5);
    ...
    m_SymbolListCtrl = new DataListReportCtrl(m_panel1, ID_LIST_SYMBOL, wxDefaultPosition, wxSize(300, 200),
...
tmSymbolDLGPolyRule::tmSymbolDLGPolyRule(wxWindow* parent, tmLayerProperties* layerproperties, wxWindowID id,
...
bool tmSymbolDLGPolyRule::Create(wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos,
                                 const wxSize& size, long style) {
    SetExtraStyle(wxWS_EX_BLOCK_EVENTS);
    tmSymbolDLG::Create(parent, id, caption, pos, size, style);
    _CreateControls();
