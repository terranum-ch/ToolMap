...
void tmSymbolDLGPolygon::CreateControlsPoly() {
  ...
  wxStaticText *itemStaticText12 =
      new wxStaticText(m_SymbolPanel, wxID_STATIC, _("Border Color :"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxStaticText *itemStaticText14 =
      new wxStaticText(m_SymbolPanel, wxID_STATIC, _("Border Width :"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxStaticText *itemStaticText16 =
      new wxStaticText(m_SymbolPanel, wxID_STATIC, _("Fill Color :"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxStaticText *itemStaticText18 =
      new wxStaticText(m_SymbolPanel, wxID_STATIC, _("Fill style :"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  m_PolygonFillPattern = new wxChoice(m_SymbolPanel, ID_SYMDLGPLG_FILL_PATTERN, wxDefaultPosition, wxDefaultSize,
                                      (sizeof(tmSYMBOLFILLSTYLES_NAME) / sizeof(wxString)), tmSYMBOLFILLSTYLES_NAME, 0);
...
void tmSymbolDLGPolyRule::_CreateControls() {
  ...
  wxStaticText *itemStaticText12 =
      new wxStaticText(m_panel2, wxID_STATIC, _("Border Color :"), wxDefaultPosition, wxDefaultSize, 0);
  itemFlexGridSizer11->Add(itemStaticText12, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);
  ...
  wxStaticText *itemStaticText14 =
      new wxStaticText(m_panel2, wxID_STATIC, _("Border Width :"), wxDefaultPosition, wxDefaultSize, 0);
  itemFlexGridSizer11->Add(itemStaticText14, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);
  ...
  wxStaticText *itemStaticText16 =
      new wxStaticText(m_panel2, wxID_STATIC, _("Fill Color :"), wxDefaultPosition, wxDefaultSize, 0);
  itemFlexGridSizer11->Add(itemStaticText16, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);
  ...
  wxStaticText *itemStaticText18 =
      new wxStaticText(m_panel2, wxID_STATIC, _("Fill style :"), wxDefaultPosition, wxDefaultSize, 0);
  itemFlexGridSizer11->Add(itemStaticText18, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);
