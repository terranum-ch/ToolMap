...
void tmSymbolDLGLineMultiple::CreateControlsLine() {
    ...
    m_LineWidthCtrl = new wxSpinCtrl(m_panel2, wxID_ANY, _T("0"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0,
                                     100, 1);
    ...
    m_TransparencySlider = new tmSliderWithText(m_SymbolPanel, wxID_ANY, 0, 0, 100, _T("%"), wxDefaultPosition,
                                                wxDefaultSize, 0);
