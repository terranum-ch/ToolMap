...
const int ID_CONTEXT_MENU_EDIT_POLY = 10335;
const int ID_CONTEXT_MENU_ENABLE_POLY = 10336;
const int ID_CONTEXT_MENU_DISABLE_POLY = 10337;
const int ID_CONTEXT_MENU_BORDER_COLOR_POLY = 10338;
const int ID_CONTEXT_MENU_BORDER_WIDTH_POLY = 10339;
const int ID_CONTEXT_MENU_FILL_COLOR_POLY = 10340;
const int ID_CONTEXT_MENU_FILL_STYLE_POLY = 10341;
const int ID_CONTEXT_MENU_TRANSPARENCY_POLY = 10342;
