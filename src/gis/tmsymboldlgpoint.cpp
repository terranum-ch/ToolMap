...
void tmSymbolDLGPoint::CreateControlsPoint() {
  ...
  wxStaticText *itemStaticText12 =
      new wxStaticText(m_SymbolPanel, wxID_STATIC, _("Color :"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxStaticText *itemStaticText14 =
      new wxStaticText(m_SymbolPanel, wxID_STATIC, _("Radius :"), wxDefaultPosition, wxDefaultSize, 0);
...
void tmSymbolDLGPointRule::_CreateControls() {
  ...
  wxStaticText *itemStaticText14 =
      new wxStaticText(m_panel2, wxID_STATIC, _("Radius :"), wxDefaultPosition, wxDefaultSize, 0);
  itemFlexGridSizer11->Add(itemStaticText14, 0, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxALL, 5);

  m_PointWidthCtrl =
      new wxSpinCtrl(m_panel2, ID_SYMDLGP_WIDTH, _T("0"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100, 0);
  itemFlexGridSizer11->Add(m_PointWidthCtrl, 0, wxGROW | wxALIGN_CENTER_VERTICAL | wxALL, 5);
  ...
  m_TransparencySlider =
      new tmSliderWithText(m_panel2, ID_SYMDLGP_TRANSPARENCY, 0, 0, 100, _T("%"), wxDefaultPosition, wxDefaultSize, 0);
  itemStaticBoxSizer22->Add(m_TransparencySlider, 1, wxGROW | wxALL, 5);
