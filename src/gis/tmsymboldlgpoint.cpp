...
void tmSymbolDLGPointRule::_CreateControls() {
    ...
    wxStaticText* itemStaticText14 = new wxStaticText( m_panel2, wxID_STATIC, _("Radius :"), wxDefaultPosition, wxDefaultSize, 0 );
    itemFlexGridSizer11->Add(itemStaticText14, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL|wxALL, 5);
	
    m_PointWidthCtrl = new wxSpinCtrl( m_panel2, ID_SYMDLGP_WIDTH, _T("0"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100, 0 );
    itemFlexGridSizer11->Add(m_PointWidthCtrl, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5);
    ...
    m_SymbolListCtrl = new DataListReportCtrl(m_panel1, ID_LIST_SYMBOL_POINT, wxDefaultPosition, wxSize( 300,200 ) ,wxLC_REPORT | wxLC_HRULES | wxLC_VRULES);
	...
	m_RemoveAllBtn = new wxButton( m_panel1, ID_BTN_REMOVEALL_POINT, _("Remove all"), wxDefaultPosition, wxDefaultSize, 0 );
...
tmSymbolDLGPointRule::tmSymbolDLGPointRule(wxWindow * parent, tmLayerProperties * layerproperties, wxWindowID id, const wxString & caption, const wxPoint & pos, const wxSize & size, long style){
...
bool tmSymbolDLGPointRule::Create(wxWindow * parent, wxWindowID id, const wxString & caption, const wxPoint & pos, const wxSize & size, long style) {
    SetExtraStyle(wxWS_EX_BLOCK_EVENTS);
    tmSymbolDLG::Create( parent, id, caption, pos, size, style );
	_CreateControls();
    return true;
