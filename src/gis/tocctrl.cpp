...
void TocCtrl::OnMenuRenameGroup(wxCommandEvent& event) {
    ...
    wxString newGroupName = wxGetTextFromUser("Group name", wxASCII_STR(wxGetTextFromUserPromptStr),
                                              model->NodeGetTitle(node));
...
void TocCtrl::OnMenuPropertiesSave(wxCommandEvent& event) {
    ...
    wxString save_filepath = wxSaveFileSelector(_("Save symbology"), layer_filename.GetExt(),
                                                layer_filename.GetFullName(), this);
...
void TocCtrl::OnMenuPropertiesLoad(wxCommandEvent& event) {
    ...
    if (myLayerNameInTxtFile != myLayerName.GetName()) {
        wxMessageDialog myDlg(this,
                              wxString::Format(_T("This symbology was saved for layer: %s. Apply for selected layer?"),
                                               myLayerNameInTxtFile),
