...
tmFullSelectTextCtrl::tmFullSelectTextCtrl(wxWindow* parent, wxWindowID id, const wxString& value, const wxPoint& pos,
...
void tmFullSelectTextCtrl::Create(wxWindow* parent, wxWindowID id, const wxString& value, const wxPoint& pos,
...
tmFullSelectSpinCtrl::tmFullSelectSpinCtrl(wxWindow* parent, wxWindowID id, const wxString& value, const wxPoint& pos,
                                           const wxSize& size, long style, int min, int max, int initial,
                                           const wxString& name) {
    m_bDoSelectAll = false;
    Create(parent, id, value, pos, size, style, min, max, initial, name);
}

void tmFullSelectSpinCtrl::Create(wxWindow* parent, wxWindowID id, const wxString& value, const wxPoint& pos,
...
void tmAAttribCtrlText::Create(wxWindow* parent, const ProjectDefMemoryFields& fieldinfo, wxWindowID id,
                               const wxPoint& pos, const wxSize& size, long style, const wxString& name) {
    ...
    m_Control = new tmFullSelectTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(200, -1), 0);
...
void tmAAttribCtrlText::SetProperties(const ProjectDefMemoryFields& fieldinfo) {
    ...
    m_ControlInfo->SetLabel(wxString::Format(_T("(%d)"), fieldinfo.m_FieldPrecision));
}
...
void tmAAttribCtrlInteger::Create(wxWindow* parent, const ProjectDefMemoryFields& fieldinfo, wxWindowID id,
                                  const wxPoint& pos, const wxSize& size, long style, const wxString& name) {
    wxPanel::Create(parent, id, pos, size, style, name);
    wxBoxSizer* bSizer24;
    bSizer24 = new wxBoxSizer(wxHORIZONTAL);
    ...
    m_Control = new tmFullSelectSpinCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(120, -1));
    SetProperties(fieldinfo);
...
void tmAAttribCtrlFloat::Create(wxWindow* parent, const ProjectDefMemoryFields& fieldinfo, wxWindowID id,
                                const wxPoint& pos, const wxSize& size, long style, const wxString& name) {
    wxPanel::Create(parent, id, pos, size, style, name);
    wxBoxSizer* bSizer24;
    bSizer24 = new wxBoxSizer(wxHORIZONTAL);
    ...
    m_Control = new tmFullSelectTextCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(120, -1), 0,
...
void tmAAttribCtrlFloat::SetProperties(const ProjectDefMemoryFields& fieldinfo) {
    ...
    for (int i = 0; i < fieldinfo.m_FieldPrecision; i++) myExemple.Append(_T("9"));

    myExemple.insert(fieldinfo.m_FieldPrecision - fieldinfo.m_FieldScale, _T("."));
...
tmAAttribCtrlEnum::tmAAttribCtrlEnum(wxWindow* parent, const ProjectDefMemoryFields& fieldinfo, wxWindowID id,
                                     const wxPoint& pos, const wxSize& size, long style, const wxString& name) {
    tmAAttribCtrlEnum::Create(parent, fieldinfo, id, pos, size, style, name);
}

void tmAAttribCtrlEnum::Create(wxWindow* parent, const ProjectDefMemoryFields& fieldinfo, wxWindowID id,
                               const wxPoint& pos, const wxSize& size, long style, const wxString& name) {
    wxPanel::Create(parent, id, pos, size, style, name);
    InitMemberValues();
...
wxSizer* tmAAttribCtrlEnum::CreateChoiceControl(const PrjMemFieldCodedValArray& valarray) {
    ...
    } else  // choice control
    {
        ...
        for (unsigned int i = 0; i < valarray.GetCount(); i++) myValues.Add(valarray.Item(i)->m_ValueName);

        m_ControlChoice = new wxChoice(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, myValues);
...
bool tmAAttribCtrlEnum::IsChoiceList() {
    if (m_ControlChoice) return true;
    return false;
}
...
void tmAAttribCtrlDate::Create(wxWindow* parent, const ProjectDefMemoryFields& fieldinfo, wxWindowID id,
                               const wxPoint& pos, const wxSize& size, long style, const wxString& name) {
    wxPanel::Create(parent, id, pos, size, style, name);
    wxBoxSizer* bSizer24;
    bSizer24 = new wxBoxSizer(wxHORIZONTAL);
...
void tmAAttribCtrlSafeDate::Create(wxWindow* parent, const ProjectDefMemoryFields& fieldinfo, wxWindowID id,
                                   const wxPoint& pos, const wxSize& size, long style, const wxString& name) {
    wxPanel::Create(parent, id, pos, size, style, name);
    wxBoxSizer* bSizer24;
    bSizer24 = new wxBoxSizer(wxHORIZONTAL);
