...
DECLARE_EVENT_TYPE(tmEVT_LM_GROUP_ADD, -1)
...
class TocCtrl : public wxDataViewCtrl {
  public:
    ...
    tmLayerProperties* GetLayerByName(
        const wxString& layerName);  // TODO: Is this function really needed, duplicate of GetLayerByPath
