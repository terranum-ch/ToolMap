...
void tmSymbolDLGLine::CreateControlsLine() {
  ...
  wxStaticText *itemStaticText14 =
      new wxStaticText(m_SymbolPanel, wxID_STATIC, _("Symbol :"), wxDefaultPosition, wxDefaultSize, 0);
  ...
  wxStaticText *itemStaticText16 =
      new wxStaticText(m_SymbolPanel, wxID_STATIC, _("Width :"), wxDefaultPosition, wxDefaultSize, 0);
...
void tmSymbolDLGLineRule::_CreateControls() {
  ...
  m_LineWidthCtrl =
      new wxSpinCtrl(m_panel2, ID_SYMDLGL_WIDTH, _T("0"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100, 1);
  itemFlexGridSizer11->Add(m_LineWidthCtrl, 0, wxGROW | wxALIGN_CENTER_VERTICAL | wxALL, 5);
  ...
  m_TransparencySlider =
      new tmSliderWithText(m_panel2, ID_SYMDLGL_TRANSPARENCY, 0, 0, 100, _T("%"), wxDefaultPosition, wxDefaultSize, 0);
  itemStaticBoxSizer24->Add(m_TransparencySlider, 1, wxGROW | wxALL, 5);
